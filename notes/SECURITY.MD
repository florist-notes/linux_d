...
<td>hide files in windows and linux systems<br /></td>
<td>x<br /></td>
</tr>
...
>  >vboxmanage dhcpserver add --network=malfoy --server-ip=10.38.1.1 --lower-ip=10.38.1.110 --upper-ip=10.38.1.120 --netmask=255.255.255.0 --enable<br />
<br /></td>
</tr>
</table>