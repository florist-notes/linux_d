...
Bash scripts help automate scraping of data, here is an example of NVIDIA Jetson Tegrastats energy data along with batch information while training deep learning model at the edge:
